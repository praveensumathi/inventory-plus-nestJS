...
@Index("ReportTmplSectionHeader_pkey", ["id"], { unique: true })
@Entity("ReportTmplSectionHeader", { schema: "public" })
export class ReportTmplSectionHeader {
  @AutoMap()
  ...
  @ManyToOne(
    () => ReportTmplSection,
    (reportTmplSection) => reportTmplSection.reportTmplSectionHeaders
  )
